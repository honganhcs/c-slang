...
export class CParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		...
		"forCondition", "forDeclaration", "forExpression", "jumpStatement", "functionDefinition", 
		"declarationList", "programItem", "program",
	];
	...
	public declarationSpecifiers(): DeclarationSpecifiersContext {
		...
		try {
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CParser.Char) | (1 << CParser.Const) | (1 << CParser.Double) | (1 << CParser.Float) | (1 << CParser.Int) | (1 << CParser.Long) | (1 << CParser.Short) | (1 << CParser.Void))) !== 0));
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public typeSpecifier(): TypeSpecifierContext {
		...
		try {
			...
			this.state = 329;
			_la = this._input.LA(1);
			if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CParser.Char) | (1 << CParser.Double) | (1 << CParser.Float) | (1 << CParser.Int) | (1 << CParser.Long) | (1 << CParser.Short) | (1 << CParser.Void))) !== 0))) {
			this._errHandler.recoverInline(this);
			} else {
				if (this._input.LA(1) === Token.EOF) {
					this.matchedEOF = true;
	...
	public specifierQualifierList(): SpecifierQualifierListContext {
		...
		try {
			...
			case CParser.Void:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CParser.Char) | (1 << CParser.Const) | (1 << CParser.Double) | (1 << CParser.Float) | (1 << CParser.Int) | (1 << CParser.Long) | (1 << CParser.Short) | (1 << CParser.Void))) !== 0)) {
					{
					this.state = 332;
	...
	public compoundStatement(): CompoundStatementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << CParser.T__0) | (1 << CParser.Break) | (1 << CParser.Char) | (1 << CParser.Const) | (1 << CParser.Continue) | (1 << CParser.Do) | (1 << CParser.Double) | (1 << CParser.Float) | (1 << CParser.For) | (1 << CParser.If) | (1 << CParser.Int) | (1 << CParser.Long) | (1 << CParser.Return) | (1 << CParser.Short) | (1 << CParser.Void) | (1 << CParser.While) | (1 << CParser.LeftParen) | (1 << CParser.LeftBrace) | (1 << CParser.Plus) | (1 << CParser.PlusPlus))) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (CParser.Minus - 32)) | (1 << (CParser.MinusMinus - 32)) | (1 << (CParser.Star - 32)) | (1 << (CParser.Not - 32)) | (1 << (CParser.Semi - 32)) | (1 << (CParser.Identifier - 32)) | (1 << (CParser.Constant - 32)) | (1 << (CParser.StringLiteral - 32)))) !== 0)) {
				{
				this.state = 503;
