...
export class CParser extends Parser {
  ...
  public parameterDeclarator(): ParameterDeclaratorContext {
    const _localctx: ParameterDeclaratorContext = new ParameterDeclaratorContext(
      this._ctx,
      this.state
    )
  ...
  public parameterDirectDeclarator(): ParameterDirectDeclaratorContext {
    const _localctx: ParameterDirectDeclaratorContext = new ParameterDirectDeclaratorContext(
      this._ctx,
      this.state
    )
...
export class ParameterDeclaratorContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return CParser.RULE_parameterDeclarator
  }
  // @Override
  public enterRule(listener: CListener): void {
...
export class ParameterDirectDeclaratorContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return CParser.RULE_parameterDirectDeclarator
  }
  // @Override
  public enterRule(listener: CListener): void {
